//
//  InputAssociationController.swift
//  AutoRecommendDemo
//
...
class InputAssociationController: UIViewController, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource {
    private var dataSource: [String] = []

    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationItem.title = "集成实现输入联想功能"
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        self.dataSource = InputAssociationTool.shared.inputAssociation(str: textField.text ?? "")
